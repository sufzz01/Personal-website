      ...
      <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-blue-950 dark:to-indigo-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 mb-4 font-medium">
                  Mahasiswa TI | Web Developer | Graphic Designer
                </p>
                <p className="text-slate-600 dark:text-slate-400 mb-8 text-lg leading-relaxed">
                  Passionate tentang teknologi, pengembangan website, manajemen database, dan sistem informasi.
                  Terus belajar dan membangun solusi digital melalui proyek akademik, pembelajaran mandiri, dan pengalaman praktis.
                </p>
              ...
              >
                <div className="relative w-full aspect-square max-w-md mx-auto">
                  ...
                  <img
                    src="/Personal-website/profil.jpeg"
                    alt="M. Yusuf"
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  {[
                    ...
                    { href: 'https://www.linkedin.com/in/sufzz', icon: Linkedin, label: 'LinkedIn', value: 'https://www.linkedin.com/in/sufzz', color: 'from-blue-700 to-blue-900' },
                    { href: 'https://github.com/sufzz01', icon: Github, label: 'GitHub', value: 'https://github.com/sufzz01', color: 'from-slate-700 to-slate-900' },
                    { href: 'https://wa.me/6285199799193', icon: MessageSquare, label: 'WhatsApp', value: '+62 851-997-99193', color: 'from-green-600 to-green-700' },
                    { href: 'https://www.instagram.com/the_sufzz', icon: InstagramIcon, label: 'instagram', value: 'https://www.instagram.com/the_sufzz', color: 'from-pink-500 to-purple-600' },
        ...
        <footer className="bg-slate-900 dark:bg-slate-950 text-slate-300 py-12 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-slate-400 mb-6">Mahasiswa TI | Web Developer | Graphic Designer</p>
            <div className="flex justify-center gap-4 mb-8">
              {[
                { href: 'mailto:sufzzz01@gmail.com', icon: Mail, label: 'Email', hover: 'hover:bg-blue-600' },
                { href: 'https://www.linkedin.com/in/sufzz', icon: Linkedin, label: 'LinkedIn', hover: 'hover:bg-blue-600' },
                ...
                { href: 'https://www.instagram.com/the_sufzz', icon: InstagramIcon, label: 'instagram', hover: 'hover:bg-pink-500' },
